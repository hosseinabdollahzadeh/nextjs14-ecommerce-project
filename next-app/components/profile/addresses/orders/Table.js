...
import Paginate from "@/components/profile/addresses/orders/Paginate";
                ...
                <table className="table align-middle">
                    ...
                    {data.orders.map(order => (
                        <tr key={order.id}>
                            ...
                            <td>
                                <span
                                    className={order.payment_status == 'موفق' ? "text-success" : "text-danger"}>{order.payment_status}</span>
                            </td>
                                            ...
                                            <div className="modal-body">
                                                <table className="table align-middle">
                                                    ...
                                                    {order.order_items.map(item => (
                                                        <tr>
                                                            <th>
                                                                <Image src={item.product_primary_image} width={80}
                                                                       height={53} alt="product-image"
                                                                       placeholder="blur"
